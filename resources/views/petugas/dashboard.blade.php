            ...
            <div class="col-lg-5">
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-body pt-0 d-flex flex-column justify-content-center">
                        <canvas id="jenisChart" height="250" style="max-height: 250px;"></canvas>
                        <div class="mt-2" id="jenisLegend"></div>
                    </div>
                </div>
            </div>
        </div>
...
@push('scripts')
    ...
    <script>
        ...
        const jenisData = {!! json_encode(
            $suratPerJenis->map(function ($item) {
