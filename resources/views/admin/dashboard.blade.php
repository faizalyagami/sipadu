                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4"
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h3 class="text-white mb-1 fw-bold">Welcome back, {{ Auth::user()->name }}! 👋</h3>
                                <p class="text-white-50 mb-0">Berikut adalah ringkasan data sistem hari ini</p>
                            </div>
        ...
        <script>
            ...
            function updateCharts(data) {
                ...
                suratChart = new Chart(ctx1, {
                    type: 'line',
                    data: {
                        labels: data.months || ['Jan', 'Feb', 'Mar', 'Apr', 'Mei', 'Jun', 'Jul', 'Agu', 'Sep', 'Okt',
                            'Nov', 'Des'
                        ],
                        datasets: [{
                            label: 'Jumlah Surat',
            ...
            `);
                ...
                let html = '';
                surats.forEach(s => {
                    const statusClass = s.status == 'pending' ? 'status-pending' :
                    ...
                    const statusIcon = s.status == 'pending' ? 'bi-clock' :
                        (s.status == 'approved' ? 'bi-check-circle' : 'bi-x-circle');
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-sm btn-outline-primary" onclick="viewSurat(${s.id})">
                            <i class="bi bi-eye"></i>
                        </button>
                    </td>
                </tr>
